...
namespace ClassObjectInstance
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // 인스턴트화 : 객체에 실제 데이터를 대입하는 과정
            // 인스턴트 : 객체는 객체지만, 각 멤버들의 데이터가 초기화되어있는 상태의 객체
            ...
            // 객체의 멤버변수는 초기화 값이 없을경우
            // BSS 영역에 저장되며, 해당영역은 모든 비트가 0으로 세팅되기때문에
    ...
    public class Human
    {
        // 보호수준을 결정하는 접근 제한자
        // public : 접근 제한 없음
        // private : 해당 객체 외 접근 접근 제한
        // protected : 해당객체 및 자식객체 외 접근제한
        // internal : 동인 어셈블리(프로젝트) 외 접근제한
        // class 의 멤버들에게 접근제한자를 명시 해두지 않을경우
        // private 가 기본값이 된다.
        public int age = 1;
        public float height;
        ...
        // 생성자
        // 객체를 생성하는 함수
        // 객체를 생성한다는 의미 : 해당 클래스타입의 맴버들을 위한 메모리공간을 전부 확보함.
        // 생성자도 기본적으로 함수
        // 반환형은 힙 영역에 동적할당한 객체의 참조

        // 참조란 ?
        // 특정 메모리의 주소를 가지고 있으며 해당 데이터를 읽고 쓸 수 있는 형태
