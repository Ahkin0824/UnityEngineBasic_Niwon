...
//이미 문법용도로 쓰고있기 때문에 식별용으로 개발자가 사용할 수 없다.
...
// namespace들 간에 겹치는 멤버가 있을떄 default 설정
// IDisposable 인터페이스의 bispose() 함수 호출 보장 - 몰라도됨 아직
...
namespace FirstProject
{
    ...
    internal class Program
    {
        ...
        // void 키워드
        // 반환 타입이 아무것도 없음
        // 연산만 수행하고 반환을 따로하지 않는 함수의 반환형태로 사용함
